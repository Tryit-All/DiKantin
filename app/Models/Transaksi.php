...
class Transaksi extends Model
{
    ...
    protected $fillable = array('status_konfirm', 'status_pesanan', 'tanggal', 'id_customer', 'id_kurir', 'id_kasir', 'total_bayar', 'total_harga', 'kembalian', 'status_pengiriman', 'bukti_pengiriman', 'model_pembayaran', 'expired_at', 'created_at', 'updated_at', 'total_biaya_kurir');
