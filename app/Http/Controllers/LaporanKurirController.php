...
class LaporanKurirController extends Controller
{
    ...
    {
        $ongkirByCourier = Transaksi::selectRaw('transaksi.id_kurir,SUM(transaksi.total_biaya_kurir) as total_ongkir, kurir.nama as nama_kurir')
            ...
            ->groupBy('transaksi.id_kurir')->get(); // Menambahkan kolom kurirs.nama ke dalam grup
    ...
    public function cekOnkirKurir($tglMulai,$tglSelesai)
    {
        ...
        $ongkirByCourier = Transaksi::selectRaw('transaksi.id_kurir,SUM(transaksi.total_biaya_kurir) as total_ongkir, kurir.nama as nama_kurir')
            ...
            ->groupBy('transaksi.id_kurir')->get();
