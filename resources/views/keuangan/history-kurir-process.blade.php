...
@section('content')
    ...
    @endphp
    <input type="text" id="id_kurir" class="d-none" value="{{ $id }}"></input>
    <div class="row mb-3 mt-3">
        ...
        <script>
            function prosesCetak() {
                ...
                var id_kantin = document.getElementById('id_kurir').value;


                // Redirect to the specified URL
                window.location.href = '/keuangan/kurir/' + id_kantin + '/history/' + dariTanggal + '/' + sampaiTanggal + '/'
            }
        </script>
