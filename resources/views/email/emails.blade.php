                            ...
                            <td>
                                <table border="0" width="430px" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                    Halo {{ $dataController['email'] }}
                                                    ,</p>
                                                <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Selamat
                                                    telah
                                                    bergabung dengan kami, semoga anda bahagia dan senang menggunakan
                                                    aplikasi
                                                    "DiKantin" kami ini.
                                                </p>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="20" style="display:block;width:20px">&nbsp;&nbsp;&nbsp;</td>
                                            <td><a href="http://127.0.0.1:8000/api/validate/verified/{{ $dataController['email'] }}"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <a href="http://127.0.0.1:8000/api/validate/verified/{{ $dataController['email'] }}"
