...
<body>
    <div class="container-fluid mt-3">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <p class="mb-0" style="margin-bottom: 0; margin-left: 38px;">: {{ now() }}</p>
        </div>
        <div style="display: flex; align-items: center;">
            <p class="mb-0" style="margin-bottom: 0; margin-left: 25px;">Sampai Tanggal</p>
            <p class="mb-0" style="margin-bottom: 0; margin-left: 23px;">: {{ now() }}</p>
        </div>
