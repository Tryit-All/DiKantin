...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/app-a9987d0a.css') }}">
...
<body class="p-0 m-0 box-border ">
    <div class="w-full  flex flex-col md:flex-row text-[#34364A]">
        <div id="Banner"
            class="w-full h-screen md:w-7/12  text-white flex flex-col justify-between font-sans relative"
            style="background-image: url('{{ asset('/img/bc-login.png') }}');">
            <div class="absolute inset-0 bg-black bg-opacity-30"></div>
            <div class="px-9 pt-8 relative z-10">
                <img src="{{ asset('/img/dikantinPutih.png') }}" class="logoo" alt="" width="230px">
            </div>
            <div class="bg-gradient-to-t from-blue-900 pl-8 pb-8 pr-[25%] relative z-10">
                <p class="text-2xl md:text-6xl mb-6 font-semibold md:leading-[75px] tracking-wide">TIME FOR BUSINESS
                    MANAGEMENT</p>
        ...
        <div id="FormSection"
            class="w-full md:w-5/12 py-4 overflow-x-hidden  flex flex-col justify-center items-center">
            ...
            <div id="Forms" class="flex flex-col gap-y-6 text-center w-full px-8 md:px-0 md:w-7/12">
            ...
            <div class="flex justify-center pt-6 pb-6 md:pb-0 items-center flex-col w-full">
