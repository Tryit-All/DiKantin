...
class DataRoleHasPermissions extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $data = [
            ...
            array("permission_id" => "10", "role_id" => "4"),
            ...
            array("permission_id" => "16", "role_id" => "4"),
            array("permission_id" => "17", "role_id" => "4"),
            array("permission_id" => "18", "role_id" => "4"),
            array("permission_id" => "19", "role_id" => "4"),
            array("permission_id" => "20", "role_id" => "4"),
            array("permission_id" => "25", "role_id" => "4"),
            array("permission_id" => "26", "role_id" => "4"),
        ...
        foreach ($data as $key => $value) {
            RoleHasPermissions::create($value);
        }
    }
}
