...
class DataUserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            array("username" => "kasir", "email" => "kasir@gmail.com", "password" => Hash::make('123456'), "id_kantin" => null, "id_role" => "2", "foto" => "profile\/ejjACKlijl7dr11f4YZNs0QmBFw32fn2OmoLBilh.png", "remember_token" => null, "created_at" => "2023-06-23 09:14:45", "updated_at" => "2023-06-23 09:14:45")
